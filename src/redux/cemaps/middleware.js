import { GET, GET_SUCCESS, GET_ERROR, GETTABLE, GETTABLE_SUCCESS, GETTABLE_ERROR, ADD, ADD_SUCCESS, ADD_ERROR, UPDATE, UPDATE_SUCCESS, UPDATE_ERROR, PATCH, PATCH_SUCCESS, PATCH_ERROR, REMOVE, REMOVE_SUCCESS, REMOVE_ERROR } from "../cemaps/actions";
...
export const get =
	...
	(action) => {
		...
		if (action.type === GET || action.type === GETTABLE) {
			fetchOData(dispatch, "https://www.uocra.net/RendicionesCoseguros/Cemap?$orderby=Nombre", GET_SUCCESS, GET_ERROR);

			// var mJson = require("../../../json/cemaps.json");
			...
			//fetchJSON(dispatch, "cemaps.json", GET_SUCCESS, GET_ERROR);
