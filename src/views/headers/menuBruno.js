...
export class menuBrunoPrincipal extends connect(store, MEDIA_CHANGE, SCREEN, USUARIO)(LitElement) {
	constructor() {
		super();
		this.area = "header";
		this.visible = false;
...
window.customElements.define("menu-bruno-principal", menuBrunoPrincipal);
